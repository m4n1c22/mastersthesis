; ModuleID = '/home/sreeram/Dev/mastersthesis/userspace_implementation/MemoryCheck/src/Benchmark/shared_pointer.cpp'
...
; <label>:5:                                      ; preds = %12, %1
  %6 = load i32, i32* %3, align 4, !dbg !4194
  %7 = icmp slt i32 %6, 100, !dbg !4197
  br i1 %7, label %8, label %15, !dbg !4198

; <label>:8:                                      ; preds = %5
  %9 = load i32, i32* @_ZN14shared_pointer1yE, align 4, !dbg !4199
  %10 = load i32, i32* @_ZN14shared_pointer2c2E, align 4, !dbg !4200
  %11 = add nsw i32 %10, %9, !dbg !4200
  store i32 %11, i32* @_ZN14shared_pointer2c2E, align 4, !dbg !4200
  br label %12, !dbg !4201

; <label>:12:                                     ; preds = %8
  %13 = load i32, i32* %3, align 4, !dbg !4202
  %14 = add nsw i32 %13, 1, !dbg !4202
  store i32 %14, i32* %3, align 4, !dbg !4202
  br label %5, !dbg !4204, !llvm.loop !4205

; <label>:15:                                     ; preds = %5
  %16 = load i32*, i32** @_ZN14shared_pointer1pE, align 8, !dbg !4207
  %17 = load i32, i32* %16, align 4, !dbg !4208
  %18 = add nsw i32 %17, 2, !dbg !4208
  store i32 %18, i32* %16, align 4, !dbg !4208
  %19 = load i32, i32* @_ZN14shared_pointer1xE, align 4, !dbg !4209
  %20 = icmp sle i32 3, %19, !dbg !4209
  br i1 %20, label %21, label %25, !dbg !4209

; <label>:21:                                     ; preds = %15
  %22 = load i32, i32* @_ZN14shared_pointer1yE, align 4, !dbg !4210
  %23 = icmp sle i32 %22, 9, !dbg !4210
  br i1 %23, label %24, label %25, !dbg !4210

; <label>:24:                                     ; preds = %21
  br label %27, !dbg !4212
...
!3788 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<shared_pointer::Thread1 *>", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN14shared_pointer7Thread1EEE")
!3789 = !{!3790, !3397}
...
!4135 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<std::default_delete<std::thread::_State> >", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJSt14default_deleteINSt6thread6_StateEEEE")
!4136 = !{!3790, !334}
...
!4777 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<shared_pointer::Thread2 *>", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN14shared_pointer7Thread2EEE")
!4778 = !{!3790, !4435}
