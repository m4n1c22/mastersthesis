; ModuleID = '/home/sreeram/Dev/mastersthesis/userspace_implementation_thesis_ver/MemoryCheck/src/Benchmark/bigshot.cpp'
...
define linkonce_odr void @_ZN7bigshot7Thread14thr1Ev(%"class.bigshot::Thread1"*) #4 comdat align 2 !dbg !4089 {
  ...
  %3 = load %"class.bigshot::Thread1"*, %"class.bigshot::Thread1"** %2, align 8
  %4 = load i8*, i8** @_ZN7bigshot1vE, align 8, !dbg !4092
  %5 = icmp ne i8* %4, null, !dbg !4092
  br i1 %5, label %6, label %9, !dbg !4094

; <label>:6:                                      ; preds = %1
  %7 = load i8*, i8** @_ZN7bigshot1vE, align 8, !dbg !4095
  %8 = call i8* @strcpy(i8* %7, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i32 0, i32 0)) #3, !dbg !4096
  br label %9, !dbg !4096
...
!746 = !DICompositeType(tag: DW_TAG_class_type, name: "ios_base", scope: !43, file: !745, line: 228, size: 1728, align: 64, flags: DIFlagFwdDecl, identifier: "_ZTSSt8ios_base")
!747 = !{!748, !751, !752, !756}
...
!782 = !DICompositeType(tag: DW_TAG_structure_type, name: "color_map", scope: !783, file: !771, line: 345, size: 8, align: 8, flags: DIFlagFwdDecl, identifier: "_ZTSN5boost5graph8keywords3tag9color_mapE")
...
!821 = !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !820, line: 44, flags: DIFlagFwdDecl, identifier: "_ZTS8_IO_FILE")
...
!3761 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<bigshot::Thread0 *>", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN7bigshot7Thread0EEE")
!3762 = !{!3763, !3365}
...
!4038 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<std::default_delete<std::thread::_State> >", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJSt14default_deleteINSt6thread6_StateEEEE")
!4039 = !{!3763, !338}
...
!4656 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<bigshot::Thread1 *>", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN7bigshot7Thread1EEE")
!4657 = !{!3763, !4314}
