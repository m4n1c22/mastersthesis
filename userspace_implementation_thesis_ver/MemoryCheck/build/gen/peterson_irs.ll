; ModuleID = '/home/sreeram/Dev/mastersthesis/userspace_implementation_thesis_ver/MemoryCheck/build/gen/peterson.bc'
...
define linkonce_odr void @_ZN8peterson7Thread04thr0Ev(%"class.peterson::Thread0"*) #4 comdat align 2 !dbg !3052 {
  ...
  %3 = load %"class.peterson::Thread0"*, %"class.peterson::Thread0"** %2, align 8
  %4 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3055
  %5 = alloca i32, !dbg !3055
  store i32 %4, i32* %5, !dbg !3055
  %6 = load i32, i32* %5, !dbg !3055
  call void @_Z10__beforeMAiPvli(i32 %6, i8* bitcast (i32* @_ZN8peterson5flag0E to i8*), i64 4, i32 1), !dbg !3055
  store i32 1, i32* @_ZN8peterson5flag0E, align 4, !dbg !3055
  call void @_Z9__afterMAi(i32 %6), !dbg !3055
  %7 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3056
  %8 = alloca i32, !dbg !3056
  store i32 %7, i32* %8, !dbg !3056
  %9 = load i32, i32* %8, !dbg !3056
  call void @_Z10__beforeMAiPvli(i32 %9, i8* bitcast (i32* @_ZN8peterson4turnE to i8*), i64 4, i32 1), !dbg !3056
  store i32 1, i32* @_ZN8peterson4turnE, align 4, !dbg !3056
  call void @_Z9__afterMAi(i32 %9), !dbg !3056
  br label %10, !dbg !3057

; <label>:10:                                     ; preds = %24, %1
  %11 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3058
  %12 = alloca i32, !dbg !3058
  store i32 %11, i32* %12, !dbg !3058
  %13 = load i32, i32* %12, !dbg !3058
  call void @_Z10__beforeMAiPvli(i32 %13, i8* bitcast (i32* @_ZN8peterson5flag1E to i8*), i64 4, i32 0), !dbg !3058
  %14 = load i32, i32* @_ZN8peterson5flag1E, align 4, !dbg !3058
  call void @_Z9__afterMAi(i32 %13), !dbg !3058
  %15 = icmp eq i32 %14, 1, !dbg !3060
  br i1 %15, label %16, label %22, !dbg !3061

; <label>:16:                                     ; preds = %10
  %17 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3062
  %18 = alloca i32, !dbg !3062
  store i32 %17, i32* %18, !dbg !3062
  %19 = load i32, i32* %18, !dbg !3062
  call void @_Z10__beforeMAiPvli(i32 %19, i8* bitcast (i32* @_ZN8peterson4turnE to i8*), i64 4, i32 0), !dbg !3062
  %20 = load i32, i32* @_ZN8peterson4turnE, align 4, !dbg !3062
  call void @_Z9__afterMAi(i32 %19), !dbg !3062
  %21 = icmp eq i32 %20, 1, !dbg !3064
  br label %22

; <label>:22:                                     ; preds = %16, %10
  %23 = phi i1 [ false, %10 ], [ %21, %16 ]
  br i1 %23, label %24, label %25, !dbg !3065

; <label>:24:                                     ; preds = %22
  br label %10, !dbg !3067, !llvm.loop !3069

; <label>:25:                                     ; preds = %22
  %26 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3070
  %27 = alloca i32, !dbg !3070
  store i32 %26, i32* %27, !dbg !3070
  %28 = load i32, i32* %27, !dbg !3070
  call void @_Z10__beforeMAiPvli(i32 %28, i8* bitcast (i32* @_ZN8peterson1xE to i8*), i64 4, i32 1), !dbg !3070
  store i32 0, i32* @_ZN8peterson1xE, align 4, !dbg !3070
  call void @_Z9__afterMAi(i32 %28), !dbg !3070
  %29 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3071
  %30 = alloca i32, !dbg !3071
  store i32 %29, i32* %30, !dbg !3071
  %31 = load i32, i32* %30, !dbg !3071
  call void @_Z10__beforeMAiPvli(i32 %31, i8* bitcast (i32* @_ZN8peterson1xE to i8*), i64 4, i32 0), !dbg !3071
  %32 = load i32, i32* @_ZN8peterson1xE, align 4, !dbg !3071
  call void @_Z9__afterMAi(i32 %31), !dbg !3071
  %33 = icmp sle i32 %32, 0, !dbg !3071
  br i1 %33, label %34, label %35, !dbg !3071
...
; <label>:37:                                     ; preds = %36, %34
  %38 = call i32 @_ZN8peterson7Thread011getThreadIdEv(%"class.peterson::Thread0"* %0), !dbg !3075
  %39 = alloca i32, !dbg !3075
  store i32 %38, i32* %39, !dbg !3075
  %40 = load i32, i32* %39, !dbg !3075
  call void @_Z10__beforeMAiPvli(i32 %40, i8* bitcast (i32* @_ZN8peterson5flag0E to i8*), i64 4, i32 1), !dbg !3075
  store i32 0, i32* @_ZN8peterson5flag0E, align 4, !dbg !3075
  call void @_Z9__afterMAi(i32 %40), !dbg !3075
  ret void, !dbg !3076
}
...
define linkonce_odr void @_ZN8peterson7Thread14thr1Ev(%"class.peterson::Thread1"*) #4 comdat align 2 !dbg !4111 {
  ...
  %3 = load %"class.peterson::Thread1"*, %"class.peterson::Thread1"** %2, align 8
  %4 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4114
  %5 = alloca i32, !dbg !4114
  store i32 %4, i32* %5, !dbg !4114
  %6 = load i32, i32* %5, !dbg !4114
  call void @_Z10__beforeMAiPvli(i32 %6, i8* bitcast (i32* @_ZN8peterson5flag1E to i8*), i64 4, i32 1), !dbg !4114
  store i32 1, i32* @_ZN8peterson5flag1E, align 4, !dbg !4114
  call void @_Z9__afterMAi(i32 %6), !dbg !4114
  %7 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4115
  %8 = alloca i32, !dbg !4115
  store i32 %7, i32* %8, !dbg !4115
  %9 = load i32, i32* %8, !dbg !4115
  call void @_Z10__beforeMAiPvli(i32 %9, i8* bitcast (i32* @_ZN8peterson4turnE to i8*), i64 4, i32 1), !dbg !4115
  store i32 0, i32* @_ZN8peterson4turnE, align 4, !dbg !4115
  call void @_Z9__afterMAi(i32 %9), !dbg !4115
  br label %10, !dbg !4116

; <label>:10:                                     ; preds = %24, %1
  %11 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4117
  %12 = alloca i32, !dbg !4117
  store i32 %11, i32* %12, !dbg !4117
  %13 = load i32, i32* %12, !dbg !4117
  call void @_Z10__beforeMAiPvli(i32 %13, i8* bitcast (i32* @_ZN8peterson5flag0E to i8*), i64 4, i32 0), !dbg !4117
  %14 = load i32, i32* @_ZN8peterson5flag0E, align 4, !dbg !4117
  call void @_Z9__afterMAi(i32 %13), !dbg !4117
  %15 = icmp eq i32 %14, 1, !dbg !4119
  br i1 %15, label %16, label %22, !dbg !4120

; <label>:16:                                     ; preds = %10
  %17 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4121
  %18 = alloca i32, !dbg !4121
  store i32 %17, i32* %18, !dbg !4121
  %19 = load i32, i32* %18, !dbg !4121
  call void @_Z10__beforeMAiPvli(i32 %19, i8* bitcast (i32* @_ZN8peterson4turnE to i8*), i64 4, i32 0), !dbg !4121
  %20 = load i32, i32* @_ZN8peterson4turnE, align 4, !dbg !4121
  call void @_Z9__afterMAi(i32 %19), !dbg !4121
  %21 = icmp eq i32 %20, 0, !dbg !4123
  br label %22
...
; <label>:24:                                     ; preds = %22
  br label %10, !dbg !4126, !llvm.loop !4128

; <label>:25:                                     ; preds = %22
  %26 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4129
  %27 = alloca i32, !dbg !4129
  store i32 %26, i32* %27, !dbg !4129
  %28 = load i32, i32* %27, !dbg !4129
  call void @_Z10__beforeMAiPvli(i32 %28, i8* bitcast (i32* @_ZN8peterson1xE to i8*), i64 4, i32 1), !dbg !4129
  store i32 1, i32* @_ZN8peterson1xE, align 4, !dbg !4129
  call void @_Z9__afterMAi(i32 %28), !dbg !4129
  %29 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4130
  %30 = alloca i32, !dbg !4130
  store i32 %29, i32* %30, !dbg !4130
  %31 = load i32, i32* %30, !dbg !4130
  call void @_Z10__beforeMAiPvli(i32 %31, i8* bitcast (i32* @_ZN8peterson1xE to i8*), i64 4, i32 0), !dbg !4130
  %32 = load i32, i32* @_ZN8peterson1xE, align 4, !dbg !4130
  call void @_Z9__afterMAi(i32 %31), !dbg !4130
  %33 = icmp sge i32 %32, 1, !dbg !4130
  br i1 %33, label %34, label %35, !dbg !4130

; <label>:34:                                     ; preds = %25
  br label %37, !dbg !4131
...
; <label>:35:                                     ; preds = %25
  ...
  unreachable, !dbg !4132
                                                  ; No predecessors!
  br label %37, !dbg !4133

; <label>:37:                                     ; preds = %36, %34
  %38 = call i32 @_ZN8peterson7Thread111getThreadIdEv(%"class.peterson::Thread1"* %0), !dbg !4134
  %39 = alloca i32, !dbg !4134
  store i32 %38, i32* %39, !dbg !4134
  %40 = load i32, i32* %39, !dbg !4134
  call void @_Z10__beforeMAiPvli(i32 %40, i8* bitcast (i32* @_ZN8peterson5flag1E to i8*), i64 4, i32 1), !dbg !4134
  store i32 0, i32* @_ZN8peterson5flag1E, align 4, !dbg !4134
  call void @_Z9__afterMAi(i32 %40), !dbg !4134
  ret void, !dbg !4135
}
...
!3783 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "tuple<peterson::Thread0 *>", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN8peterson7Thread0EEE")
!3784 = !{!3785, !3387}
...
!4060 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "tuple<std::default_delete<std::thread::_State> >", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJSt14default_deleteINSt6thread6_StateEEEE")
!4061 = !{!3785, !338}
...
!4694 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "tuple<peterson::Thread1 *>", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN8peterson7Thread1EEE")
!4695 = !{!3785, !4352}
