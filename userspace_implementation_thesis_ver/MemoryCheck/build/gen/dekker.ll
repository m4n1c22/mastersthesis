; ModuleID = '/home/sreeram/Dev/mastersthesis/userspace_implementation_thesis_ver/MemoryCheck/src/Benchmark/dekker.cpp'
...
; <label>:4:                                      ; preds = %16, %1
  %5 = load i32, i32* @_ZN6dekker5flag1E, align 4, !dbg !3057
  %6 = icmp sge i32 %5, 1, !dbg !3059
  br i1 %6, label %7, label %17, !dbg !3060

; <label>:7:                                      ; preds = %4
  %8 = load i32, i32* @_ZN6dekker4turnE, align 4, !dbg !3061
  %9 = icmp ne i32 %8, 0, !dbg !3064
  br i1 %9, label %10, label %16, !dbg !3065

; <label>:10:                                     ; preds = %7
  store i32 0, i32* @_ZN6dekker5flag0E, align 4, !dbg !3066
  br label %11, !dbg !3068

; <label>:11:                                     ; preds = %14, %10
  %12 = load i32, i32* @_ZN6dekker4turnE, align 4, !dbg !3069
  %13 = icmp ne i32 %12, 0, !dbg !3071
  br i1 %13, label %14, label %15, !dbg !3072

; <label>:14:                                     ; preds = %11
  br label %11, !dbg !3073, !llvm.loop !3075

; <label>:15:                                     ; preds = %11
  store i32 1, i32* @_ZN6dekker5flag0E, align 4, !dbg !3076
  br label %16, !dbg !3077

; <label>:16:                                     ; preds = %15, %7
  br label %4, !dbg !3078, !llvm.loop !3080

; <label>:17:                                     ; preds = %4
  store i32 0, i32* @_ZN6dekker1xE, align 4, !dbg !3081
  %18 = load i32, i32* @_ZN6dekker1xE, align 4, !dbg !3082
  %19 = icmp sle i32 %18, 0, !dbg !3082
  br i1 %19, label %20, label %21, !dbg !3082

; <label>:20:                                     ; preds = %17
  br label %23, !dbg !3083
...
; <label>:4:                                      ; preds = %16, %1
  %5 = load i32, i32* @_ZN6dekker5flag0E, align 4, !dbg !4129
  %6 = icmp sge i32 %5, 1, !dbg !4131
  br i1 %6, label %7, label %17, !dbg !4132

; <label>:7:                                      ; preds = %4
  %8 = load i32, i32* @_ZN6dekker4turnE, align 4, !dbg !4133
  %9 = icmp ne i32 %8, 1, !dbg !4136
  br i1 %9, label %10, label %16, !dbg !4137
...
; <label>:11:                                     ; preds = %14, %10
  %12 = load i32, i32* @_ZN6dekker4turnE, align 4, !dbg !4141
  %13 = icmp ne i32 %12, 1, !dbg !4143
  br i1 %13, label %14, label %15, !dbg !4144

; <label>:14:                                     ; preds = %11
  br label %11, !dbg !4145, !llvm.loop !4147
...
; <label>:16:                                     ; preds = %15, %7
  br label %4, !dbg !4150, !llvm.loop !4152

; <label>:17:                                     ; preds = %4
  store i32 1, i32* @_ZN6dekker1xE, align 4, !dbg !4153
  %18 = load i32, i32* @_ZN6dekker1xE, align 4, !dbg !4154
  %19 = icmp sge i32 %18, 1, !dbg !4154
  br i1 %19, label %20, label %21, !dbg !4154

; <label>:20:                                     ; preds = %17
  br label %23, !dbg !4155
...
!3796 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<dekker::Thread0 *>", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN6dekker7Thread0EEE")
!3797 = !{!3798, !3400}
...
!4073 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<std::default_delete<std::thread::_State> >", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJSt14default_deleteINSt6thread6_StateEEEE")
!4074 = !{!3798, !338}
...
!4720 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<dekker::Thread1 *>", scope: !43, file: !143, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN6dekker7Thread1EEE")
!4721 = !{!3798, !4378}
