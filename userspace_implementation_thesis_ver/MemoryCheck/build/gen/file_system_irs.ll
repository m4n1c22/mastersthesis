; ModuleID = '/home/sreeram/Dev/mastersthesis/userspace_implementation/MemoryCheck/build/gen/file_system.bc'
...
define linkonce_odr void @_ZN11file_system8WorkUnit4execEv(%"class.file_system::WorkUnit"*) #0 comdat align 2 !dbg !3722 {
  ...
  %13 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3734
  %14 = alloca i32, !dbg !3734
  store i32 %13, i32* %14, !dbg !3734
  %15 = load i32, i32* %14, !dbg !3734
  %16 = bitcast %"class.std::mutex"* %12 to i8*, !dbg !3734
  call void @_Z10__beforeMAiPvli(i32 %15, i8* %16, i64 8, i32 1), !dbg !3734
  call void @_ZNSt5mutex4lockEv(%"class.std::mutex"* %12), !dbg !3734
  call void @_Z9__afterMAi(i32 %15), !dbg !3734
  %17 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 0, !dbg !3735
  %18 = load i32, i32* %17, align 8, !dbg !3735
  %19 = sext i32 %18 to i64, !dbg !3737
  %20 = getelementptr inbounds [32 x i32], [32 x i32]* @_ZN11file_system6gInodeE, i64 0, i64 %19, !dbg !3737
  %21 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3737
  %22 = alloca i32, !dbg !3737
  store i32 %21, i32* %22, !dbg !3737
  %23 = load i32, i32* %22, !dbg !3737
  %24 = bitcast i32* %20 to i8*, !dbg !3737
  call void @_Z10__beforeMAiPvli(i32 %23, i8* %24, i64 4, i32 0), !dbg !3737
  %25 = load i32, i32* %20, align 4, !dbg !3737
  call void @_Z9__afterMAi(i32 %23), !dbg !3737
  %26 = icmp eq i32 %25, 0, !dbg !3738
  br i1 %26, label %27, label %93, !dbg !3739

; <label>:27:                                     ; preds = %1
  %28 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 0, !dbg !3740
  %29 = load i32, i32* %28, align 8, !dbg !3740
  %30 = mul nsw i32 %29, 2, !dbg !3742
  %31 = srem i32 %30, 26, !dbg !3743
  %32 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3744
  store i32 %31, i32* %32, align 4, !dbg !3745
  br label %33, !dbg !3746

; <label>:33:                                     ; preds = %27, %78
  %34 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3747
  %35 = load i32, i32* %34, align 4, !dbg !3747
  %36 = sext i32 %35 to i64, !dbg !3749
  %37 = getelementptr inbounds [26 x %"class.std::mutex"], [26 x %"class.std::mutex"]* bitcast ([26 x { %union.pthread_mutex_t }]* @_ZN11file_system5lockbE to [26 x %"class.std::mutex"]*), i64 0, i64 %36, !dbg !3749
  %38 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3750
  %39 = alloca i32, !dbg !3750
  store i32 %38, i32* %39, !dbg !3750
  %40 = load i32, i32* %39, !dbg !3750
  %41 = bitcast %"class.std::mutex"* %37 to i8*, !dbg !3750
  call void @_Z10__beforeMAiPvli(i32 %40, i8* %41, i64 8, i32 1), !dbg !3750
  call void @_ZNSt5mutex4lockEv(%"class.std::mutex"* %37), !dbg !3750
  call void @_Z9__afterMAi(i32 %40), !dbg !3750
  %42 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3751
  %43 = load i32, i32* %42, align 4, !dbg !3751
  %44 = sext i32 %43 to i64, !dbg !3753
  %45 = getelementptr inbounds [26 x i8], [26 x i8]* @_ZN11file_system5gBusyE, i64 0, i64 %44, !dbg !3753
  %46 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3753
  %47 = alloca i32, !dbg !3753
  store i32 %46, i32* %47, !dbg !3753
  %48 = load i32, i32* %47, !dbg !3753
  call void @_Z10__beforeMAiPvli(i32 %48, i8* %45, i64 1, i32 0), !dbg !3753
  %49 = load i8, i8* %45, align 1, !dbg !3753
  call void @_Z9__afterMAi(i32 %48), !dbg !3753
  %50 = trunc i8 %49 to i1, !dbg !3753
  br i1 %50, label %78, label %51, !dbg !3754

; <label>:51:                                     ; preds = %33
  %52 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3755
  %53 = load i32, i32* %52, align 4, !dbg !3755
  %54 = sext i32 %53 to i64, !dbg !3757
  %55 = getelementptr inbounds [26 x i8], [26 x i8]* @_ZN11file_system5gBusyE, i64 0, i64 %54, !dbg !3757
  %56 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3758
  %57 = alloca i32, !dbg !3758
  store i32 %56, i32* %57, !dbg !3758
  %58 = load i32, i32* %57, !dbg !3758
  call void @_Z10__beforeMAiPvli(i32 %58, i8* %55, i64 1, i32 1), !dbg !3758
  store i8 1, i8* %55, align 1, !dbg !3758
  call void @_Z9__afterMAi(i32 %58), !dbg !3758
  %59 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3759
  %60 = load i32, i32* %59, align 4, !dbg !3759
  %61 = add nsw i32 %60, 1, !dbg !3760
  %62 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 0, !dbg !3761
  %63 = load i32, i32* %62, align 8, !dbg !3761
  %64 = sext i32 %63 to i64, !dbg !3762
  %65 = getelementptr inbounds [32 x i32], [32 x i32]* @_ZN11file_system6gInodeE, i64 0, i64 %64, !dbg !3762
  %66 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3763
  %67 = alloca i32, !dbg !3763
  store i32 %66, i32* %67, !dbg !3763
  %68 = load i32, i32* %67, !dbg !3763
  %69 = bitcast i32* %65 to i8*, !dbg !3763
  call void @_Z10__beforeMAiPvli(i32 %68, i8* %69, i64 4, i32 1), !dbg !3763
  store i32 %61, i32* %65, align 4, !dbg !3763
  call void @_Z9__afterMAi(i32 %68), !dbg !3763
  %70 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3764
  %71 = load i32, i32* %70, align 4, !dbg !3764
  %72 = sext i32 %71 to i64, !dbg !3765
  %73 = getelementptr inbounds [26 x %"class.std::mutex"], [26 x %"class.std::mutex"]* bitcast ([26 x { %union.pthread_mutex_t }]* @_ZN11file_system5lockbE to [26 x %"class.std::mutex"]*), i64 0, i64 %72, !dbg !3765
  %74 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3766
  %75 = alloca i32, !dbg !3766
  store i32 %74, i32* %75, !dbg !3766
  %76 = load i32, i32* %75, !dbg !3766
  %77 = bitcast %"class.std::mutex"* %73 to i8*, !dbg !3766
  call void @_Z10__beforeMAiPvli(i32 %76, i8* %77, i64 8, i32 1), !dbg !3766
  call void @_ZNSt5mutex6unlockEv(%"class.std::mutex"* %73), !dbg !3766
  call void @_Z9__afterMAi(i32 %76), !dbg !3766
  br label %92, !dbg !3767

; <label>:78:                                     ; preds = %33
  %79 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3768
  %80 = load i32, i32* %79, align 4, !dbg !3768
  %81 = sext i32 %80 to i64, !dbg !3769
  %82 = getelementptr inbounds [26 x %"class.std::mutex"], [26 x %"class.std::mutex"]* bitcast ([26 x { %union.pthread_mutex_t }]* @_ZN11file_system5lockbE to [26 x %"class.std::mutex"]*), i64 0, i64 %81, !dbg !3769
  %83 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3770
  %84 = alloca i32, !dbg !3770
  store i32 %83, i32* %84, !dbg !3770
  %85 = load i32, i32* %84, !dbg !3770
  %86 = bitcast %"class.std::mutex"* %82 to i8*, !dbg !3770
  call void @_Z10__beforeMAiPvli(i32 %85, i8* %86, i64 8, i32 1), !dbg !3770
  call void @_ZNSt5mutex6unlockEv(%"class.std::mutex"* %82), !dbg !3770
  call void @_Z9__afterMAi(i32 %85), !dbg !3770
  %87 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3771
  %88 = load i32, i32* %87, align 4, !dbg !3771
  %89 = add nsw i32 %88, 1, !dbg !3772
  %90 = srem i32 %89, 26, !dbg !3773
  %91 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 1, !dbg !3774
  store i32 %90, i32* %91, align 4, !dbg !3775
  br label %33, !dbg !3776, !llvm.loop !3778

; <label>:92:                                     ; preds = %51
  br label %93, !dbg !3779

; <label>:93:                                     ; preds = %92, %1
  %94 = getelementptr inbounds %"class.file_system::WorkUnit", %"class.file_system::WorkUnit"* %4, i32 0, i32 0, !dbg !3780
  %95 = load i32, i32* %94, align 8, !dbg !3780
  %96 = sext i32 %95 to i64, !dbg !3781
  %97 = getelementptr inbounds [32 x %"class.std::mutex"], [32 x %"class.std::mutex"]* bitcast ([32 x { %union.pthread_mutex_t }]* @_ZN11file_system5lockiE to [32 x %"class.std::mutex"]*), i64 0, i64 %96, !dbg !3781
  %98 = call i32 @_ZN11file_system8WorkUnit11getThreadIdEv(%"class.file_system::WorkUnit"* %0), !dbg !3782
  %99 = alloca i32, !dbg !3782
  store i32 %98, i32* %99, !dbg !3782
  %100 = load i32, i32* %99, !dbg !3782
  %101 = bitcast %"class.std::mutex"* %97 to i8*, !dbg !3782
  call void @_Z10__beforeMAiPvli(i32 %100, i8* %101, i64 8, i32 1), !dbg !3782
  call void @_ZNSt5mutex6unlockEv(%"class.std::mutex"* %97), !dbg !3782
  call void @_Z9__afterMAi(i32 %100), !dbg !3782
  ret void, !dbg !3783
}
