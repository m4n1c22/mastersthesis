...
#check if the log file exists or not.
if [ -f dining_phil_trace_0_proto_5.dat ]
then
	sudo rm dining_phil_trace_0_proto_5.dat
fi
if [ -f dining_phil_trace_1_proto_5.dat ]
then
	sudo rm dining_phil_trace_1_proto_5.dat
fi
if [ -f dining_phil_trace_2_proto_5.dat ]
then
	sudo rm dining_phil_trace_2_proto_5.dat
fi
