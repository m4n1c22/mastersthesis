...
#check if the log file exists or not.
if [ -f exec_time_trace_0_proto_6.dat ]
then
	sudo rm exec_time_trace_0_proto_6.dat
fi
if [ -f exec_time_trace_1_proto_6.dat ]
then
	sudo rm exec_time_trace_1_proto_6.dat
fi
if [ -f exec_time_trace_2_proto_6.dat ]
then
	sudo rm exec_time_trace_2_proto_6.dat
fi
if [ -f exec_time_trace_3_proto_6.dat ]
then
	sudo rm exec_time_trace_3_proto_6.dat
fi
