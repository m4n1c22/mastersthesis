...
#check if the log file exists or not.
if [ -f indexer_t15_trace_0_proto_6.dat ]
then
	sudo rm indexer_t15_trace_0_proto_6.dat
fi
if [ -f indexer_t15_trace_1_proto_6.dat ]
then
	sudo rm indexer_t15_trace_1_proto_6.dat
fi
if [ -f indexer_t15_trace_2_proto_6.dat ]
then
	sudo rm indexer_t15_trace_2_proto_6.dat
fi
if [ -f indexer_t15_trace_3_proto_6.dat ]
then
	sudo rm indexer_t15_trace_3_proto_6.dat
fi
if [ -f indexer_t15_trace_4_proto_6.dat ]
then
	sudo rm indexer_t15_trace_4_proto_6.dat
fi
if [ -f indexer_t15_trace_5_proto_6.dat ]
then
	sudo rm indexer_t15_trace_5_proto_6.dat
fi
