...
#check if the log file exists or not.
if [ -f last_zero_trace_0_proto_2.dat ]
then
	sudo rm last_zero_trace_0_proto_2.dat
fi
if [ -f last_zero_trace_1_proto_2.dat ]
then
	sudo rm last_zero_trace_1_proto_2.dat
fi
if [ -f last_zero_trace_2_proto_2.dat ]
then
	sudo rm last_zero_trace_2_proto_2.dat
fi
if [ -f last_zero_trace_3_proto_2.dat ]
then
	sudo rm last_zero_trace_3_proto_2.dat
fi
