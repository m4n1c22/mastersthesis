; ModuleID = '/home/sreeram/Dev/mastersthesis/MemoryCheck/src/Benchmark/peterson.cpp'
source_filename = "/home/sreeram/Dev/mastersthesis/MemoryCheck/src/Benchmark/peterson.cpp"
...
@.str.6 = private unnamed_addr constant [71 x i8] c"/home/sreeram/Dev/mastersthesis/MemoryCheck/src/Benchmark/peterson.cpp\00", section "llvm.metadata"
...
@.str.9 = private unnamed_addr constant [71 x i8] c"/home/sreeram/Dev/mastersthesis/MemoryCheck/src/Benchmark/peterson.cpp\00", align 1
...
; <label>:4:                                      ; preds = %12, %1
  %5 = load i32, i32* @_ZN8peterson5flag1E, align 4, !dbg !3053
  %6 = icmp eq i32 %5, 1, !dbg !3055
  br i1 %6, label %7, label %10, !dbg !3056

; <label>:7:                                      ; preds = %4
  %8 = load i32, i32* @_ZN8peterson4turnE, align 4, !dbg !3057
  %9 = icmp eq i32 %8, 1, !dbg !3059
  br label %10
...
; <label>:12:                                     ; preds = %10
  br label %4, !dbg !3062, !llvm.loop !3064

; <label>:13:                                     ; preds = %10
  store i32 0, i32* @_ZN8peterson1xE, align 4, !dbg !3065
  %14 = load i32, i32* @_ZN8peterson1xE, align 4, !dbg !3066
  %15 = icmp sle i32 %14, 0, !dbg !3066
  br i1 %15, label %16, label %17, !dbg !3066

; <label>:16:                                     ; preds = %13
  br label %19, !dbg !3067

; <label>:17:                                     ; preds = %13
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.9, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__PRETTY_FUNCTION__._ZN8peterson7Thread04thr0Ev, i32 0, i32 0)) #14, !dbg !3068
...
; <label>:4:                                      ; preds = %12, %1
  %5 = load i32, i32* @_ZN8peterson5flag0E, align 4, !dbg !4177
  %6 = icmp eq i32 %5, 1, !dbg !4179
  br i1 %6, label %7, label %10, !dbg !4180

; <label>:7:                                      ; preds = %4
  %8 = load i32, i32* @_ZN8peterson4turnE, align 4, !dbg !4181
  %9 = icmp eq i32 %8, 0, !dbg !4183
  br label %10

; <label>:10:                                     ; preds = %7, %4
  %11 = phi i1 [ false, %4 ], [ %9, %7 ]
  br i1 %11, label %12, label %13, !dbg !4184

; <label>:12:                                     ; preds = %10
  br label %4, !dbg !4186, !llvm.loop !4188

; <label>:13:                                     ; preds = %10
  store i32 1, i32* @_ZN8peterson1xE, align 4, !dbg !4189
  %14 = load i32, i32* @_ZN8peterson1xE, align 4, !dbg !4190
  %15 = icmp sge i32 %14, 1, !dbg !4190
  br i1 %15, label %16, label %17, !dbg !4190

; <label>:16:                                     ; preds = %13
  br label %19, !dbg !4191

; <label>:17:                                     ; preds = %13
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.9, i32 0, i32 0), i32 56, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__PRETTY_FUNCTION__._ZN8peterson7Thread14thr1Ev, i32 0, i32 0)) #14, !dbg !4192
...
!1 = !DIFile(filename: "/home/sreeram/Dev/mastersthesis/MemoryCheck/src/Benchmark/peterson.cpp", directory: "/home/sreeram/Dev/mastersthesis/MemoryCheck/build/src/Benchmark")
!2 = !{!3, !11, !21}
...
!60 = !DIFile(filename: "/home/sreeram/Dev/mastersthesis/MemoryCheck/src/Benchmark/../../include/Benchmark/peterson.h", directory: "/home/sreeram/Dev/mastersthesis/MemoryCheck/build/src/Benchmark")
...
!3085 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/6.2.0/../../../../include/c++/6.2.0/bits/move.h", directory: "/home/sreeram/Dev/mastersthesis/MemoryCheck/build/src/Benchmark")
...
!3706 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/6.2.0/../../../../include/c++/6.2.0/utility", directory: "/home/sreeram/Dev/mastersthesis/MemoryCheck/build/src/Benchmark")
!3707 = !{!3708}
...
!3773 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<peterson::Thread0 *>", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN8peterson7Thread0EEE")
!3774 = !{!3775, !3382}
...
!4120 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<std::default_delete<std::thread::_State> >", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJSt14default_deleteINSt6thread6_StateEEEE")
!4121 = !{!3775, !334}
...
!4754 = !DICompositeType(tag: DW_TAG_class_type, name: "tuple<peterson::Thread1 *>", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN8peterson7Thread1EEE")
!4755 = !{!3775, !4412}
