; ModuleID = '/home/sreeram/Dev/mastersthesis/MemoryCheck/build/gen/shared_pointer.bc'
...
; <label>:42:                                     ; preds = %41, %39
  %43 = load i32, i32* @_ZN14shared_pointer2c1E, align 4, !dbg !3086
  %44 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cerr, i32 %43), !dbg !3087
  ret void, !dbg !3088
}
...
define linkonce_odr void @_ZN14shared_pointer7Thread24execEv(%"class.shared_pointer::Thread2"*) #0 comdat align 2 !dbg !4188 {
  ...
  %5 = call i32 @_ZN14shared_pointer7Thread211getThreadIdEv(%"class.shared_pointer::Thread2"* %0), !dbg !4191
  %6 = alloca i32, !dbg !4191
  store i32 %5, i32* %6, !dbg !4191
  %7 = load i32, i32* %6, !dbg !4191
  call void @_Z10__beforeMAiPvli(i32 %7, i8* bitcast (i32** @_ZN14shared_pointer1pE to i8*), i64 8, i32 1), !dbg !4191
  store i32* @_ZN14shared_pointer1xE, i32** @_ZN14shared_pointer1pE, align 8, !dbg !4191
  call void @_Z9__afterMAi(i32 %7), !dbg !4191
  call void @llvm.dbg.declare(metadata i32* %3, metadata !4192, metadata !2771), !dbg !4194
  store i32 0, i32* %3, align 4, !dbg !4194
  br label %8, !dbg !4195

; <label>:8:                                      ; preds = %18, %1
  %9 = load i32, i32* %3, align 4, !dbg !4196
  %10 = icmp slt i32 %9, 100, !dbg !4199
  br i1 %10, label %11, label %21, !dbg !4200

; <label>:11:                                     ; preds = %8
  %12 = call i32 @_ZN14shared_pointer7Thread211getThreadIdEv(%"class.shared_pointer::Thread2"* %0), !dbg !4201
  %13 = alloca i32, !dbg !4201
  store i32 %12, i32* %13, !dbg !4201
  %14 = load i32, i32* %13, !dbg !4201
  call void @_Z10__beforeMAiPvli(i32 %14, i8* bitcast (i32* @_ZN14shared_pointer1yE to i8*), i64 4, i32 0), !dbg !4201
  %15 = load i32, i32* @_ZN14shared_pointer1yE, align 4, !dbg !4201
  call void @_Z9__afterMAi(i32 %14), !dbg !4201
  %16 = load i32, i32* @_ZN14shared_pointer2c2E, align 4, !dbg !4202
  %17 = add nsw i32 %16, %15, !dbg !4202
  store i32 %17, i32* @_ZN14shared_pointer2c2E, align 4, !dbg !4202
  br label %18, !dbg !4203

; <label>:18:                                     ; preds = %11
  %19 = load i32, i32* %3, align 4, !dbg !4204
  %20 = add nsw i32 %19, 1, !dbg !4204
  store i32 %20, i32* %3, align 4, !dbg !4204
  br label %8, !dbg !4206, !llvm.loop !4207

; <label>:21:                                     ; preds = %8
  %22 = call i32 @_ZN14shared_pointer7Thread211getThreadIdEv(%"class.shared_pointer::Thread2"* %0), !dbg !4209
  %23 = alloca i32, !dbg !4209
  store i32 %22, i32* %23, !dbg !4209
  %24 = load i32, i32* %23, !dbg !4209
  call void @_Z10__beforeMAiPvli(i32 %24, i8* bitcast (i32** @_ZN14shared_pointer1pE to i8*), i64 8, i32 0), !dbg !4209
  %25 = load i32*, i32** @_ZN14shared_pointer1pE, align 8, !dbg !4209
  call void @_Z9__afterMAi(i32 %24), !dbg !4209
  %26 = load i32, i32* %25, align 4, !dbg !4210
  %27 = add nsw i32 %26, 2, !dbg !4210
  store i32 %27, i32* %25, align 4, !dbg !4210
  %28 = call i32 @_ZN14shared_pointer7Thread211getThreadIdEv(%"class.shared_pointer::Thread2"* %0), !dbg !4211
  %29 = alloca i32, !dbg !4211
  store i32 %28, i32* %29, !dbg !4211
  %30 = load i32, i32* %29, !dbg !4211
  call void @_Z10__beforeMAiPvli(i32 %30, i8* bitcast (i32* @_ZN14shared_pointer1xE to i8*), i64 4, i32 0), !dbg !4211
  %31 = load i32, i32* @_ZN14shared_pointer1xE, align 4, !dbg !4211
  call void @_Z9__afterMAi(i32 %30), !dbg !4211
  %32 = icmp sle i32 3, %31, !dbg !4211
  br i1 %32, label %33, label %40, !dbg !4211

; <label>:33:                                     ; preds = %21
  %34 = call i32 @_ZN14shared_pointer7Thread211getThreadIdEv(%"class.shared_pointer::Thread2"* %0), !dbg !4212
  %35 = alloca i32, !dbg !4212
  store i32 %34, i32* %35, !dbg !4212
  %36 = load i32, i32* %35, !dbg !4212
  call void @_Z10__beforeMAiPvli(i32 %36, i8* bitcast (i32* @_ZN14shared_pointer1yE to i8*), i64 4, i32 0), !dbg !4212
  %37 = load i32, i32* @_ZN14shared_pointer1yE, align 4, !dbg !4212
  call void @_Z9__afterMAi(i32 %36), !dbg !4212
  %38 = icmp sle i32 %37, 9, !dbg !4212
  br i1 %38, label %39, label %40, !dbg !4212

; <label>:39:                                     ; preds = %33
  br label %42, !dbg !4214
...
; <label>:42:                                     ; preds = %41, %39
  %43 = load i32, i32* @_ZN14shared_pointer2c2E, align 4, !dbg !4220
  %44 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cerr, i32 %43), !dbg !4221
  ret void, !dbg !4222
}
...
!3790 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "tuple<shared_pointer::Thread1 *>", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN14shared_pointer7Thread1EEE")
!3791 = !{!3792, !3399}
...
!4137 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "tuple<std::default_delete<std::thread::_State> >", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJSt14default_deleteINSt6thread6_StateEEEE")
!4138 = !{!3792, !334}
...
!4781 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "tuple<shared_pointer::Thread2 *>", scope: !43, file: !139, line: 554, flags: DIFlagFwdDecl, identifier: "_ZTSSt5tupleIJPN14shared_pointer7Thread2EEE")
!4782 = !{!3792, !4439}
