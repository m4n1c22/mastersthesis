...
\addvspace {10\p@ }
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {4.1}Uninstrumented User Program}{17}{lstlisting.4.1}
\contentsline {lstlisting}{\numberline {4.2}Instrumented User Program}{17}{lstlisting.4.2}
\contentsline {lstlisting}{\numberline {4.3}Yield functionality and thread revival}{19}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}First Approach}{19}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}Second Approach}{19}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {4.6}Pseudo Code for checking memory access permission}{25}{lstlisting.4.6}
