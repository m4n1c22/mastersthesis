...
\begin{lstlisting}[mathescape=true,style=customc,caption=Pseudo Code for checking memory access permission,frame=tlrb]{Name}
...
The pseudo implementation for the checking for memory access permission is depicted in Listing 4.6. 
All the prototypes in this thesis would be using the implementation shown in Listing 4.6 for checking the memory access permission.
...
\begin{lstlisting}[mathescape=true,caption=Pseudo Code for Prototype 1, style=customc,frame=tlrb]{Name}
User Space:
Thread j($j \in 1..N$):
BeforeMA() {	
...
\begin{lstlisting}[mathescape=true,caption=Pseudo Code for Prototype 2, style=customc,frame=tlrb]{Name}
User Space:
Thread j($j \in 1..N$):
BeforeMA() {	
	ioctl(CONTEXT_SWITCH, thread_id);	
...
Prototypes 5 and 6 use a similar setup as shown in Listing 4.9. 
...
\begin{lstlisting}[mathescape=true,caption=Pseudo Code for Prototype 5 and 6, style=customc,frame=tlrb]{Name}
User Space:
Thread j($j \in 1..N$):
BeforeMA() {	
...
Listing 4.10 and 4.11 depicts Prototypes 3 and 4.  

\begin{lstlisting}[mathescape=true,caption=Pseudo Code for Prototype 3, style=customc,frame=tlrb]{Name}
...
\end{lstlisting} 
\begin{lstlisting}[mathescape=true,caption=Pseudo Code for Prototype 4, style=customc,frame=tlrb]{Name}
//rest remains the same.
Kernel Space:
Queue waitqueue={}
ctxt_switch_thread(thread_id tid) {	
