...
%Custom blocks
\node (Tr) [custblock] {Trace};
\node (IPgm) [custblock,yshift=-2cm] {Instrumented Program};
\node (Sched) [custblock,yshift=-1cm,xshift =5cm] {Scheduler};
...
We have two different class of approaches used for this thesis. 
