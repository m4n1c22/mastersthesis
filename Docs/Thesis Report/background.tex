...
\begin{figure}[h]
     \centering
     \subfloat[][Conventional Verification]{\includegraphics[scale=0.1]{figs/conventional.png}\label{conv_ver}}
     \subfloat[][Iterative Relaxed Scheduling]{\includegraphics[scale=0.1]{figs/irs_only.png}\label{irs_only}}
